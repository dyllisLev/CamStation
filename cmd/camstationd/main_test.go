...
func TestCamerasPageUsesProfileRegistrationFlow(t *testing.T) {
	...
	paths := []string{
		...
		filepath.Join("..", "..", "web", "src", "pages", "cameras", "CameraWorkflow.tsx"),
		filepath.Join("..", "..", "web", "src", "pages", "cameras", "CameraWorkflowMatches.tsx"),
		filepath.Join("..", "..", "web", "src", "pages", "cameras", "ProfileLibrary.tsx"),
		filepath.Join("..", "..", "web", "src", "pages", "cameras", "ProfileLibraryControls.tsx"),
		filepath.Join("..", "..", "web", "src", "pages", "cameras", "profileLibraryModel.ts"),
