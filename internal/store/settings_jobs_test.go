...
func TestSettings_BackupScheduleAndProtectDefaultsPersist(t *testing.T) {
	t.Parallel()
	...
	if read.Backup.ScheduleIntervalMinutes != 1440 {
		t.Fatalf("default schedule interval = %d, want 1440", read.Backup.ScheduleIntervalMinutes)
	}
	...
	if !updated.Backup.ScheduleEnabled || updated.Backup.ScheduleIntervalMinutes != 60 {
